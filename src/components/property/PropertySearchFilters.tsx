...
export const PropertySearchFilters = ({
    ...
    return (
        <div className="space-y-6">
            <div>
                <h3 className="text-sm font-medium dark:text-gray-200 text-gray-700 mb-3">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    <h3 className="text-sm font-medium dark:text-white text-gray-700 mb-3">
                        Amenities & Features
                    </h3>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <label className="flex items-center space-x-2 cursor-pointer">
                            <input
                                ...
                                onChange={(e) =>
                                    handleInputChange("petfriendly", e.target.checked ? "true" : "")
                                }
                        ...
                        <label className="flex items-center space-x-2 cursor-pointer">
                            <input
                                ...
                                onChange={(e) =>
                                    handleInputChange("firesafety", e.target.checked ? "true" : "")
                                }
                                className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                            />
                            <span className="text-sm dark:text-gray-200 text-gray-700">
                        ...
                        <label className="flex items-center space-x-2 cursor-pointer">
                            <input
                                ...
                                onChange={(e) =>
                                    handleInputChange("verified", e.target.checked ? "true" : "")
                                }
                                className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                            />
                            <span className="text-sm dark:text-gray-200 text-gray-700">
