...
export default function PropertySummaryForReview({
    property,
    averageRating,
    totalReviews,
}: PropertySummaryProps) {
    const discountedPrice =
        property.discount > 0 ? property.price - property.discount : property.price;
            ...
            <div className="p-6 space-y-4">
                ...
                <div className="flex items-center gap-3 pt-2 border-t border-gray-200 dark:border-gray-600">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">Property Host</p>
                    </div>
                </div>
