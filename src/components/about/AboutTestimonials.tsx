            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                        Real experiences from real customers who have found their perfect rental
                        properties through BookIT.
                    </p>
                </div>
                            ...
                            <div className="flex items-center justify-center gap-4">
                                ...
                                <div className="text-right max-w-[75%]">
                                    ...
                                    <div className="text-sm text-gray-600 dark:text-gray-400">
                                        Stayed at {testimonial.property.title},{" "}
                                        {testimonial.property.address}, {testimonial.property.city},{" "}
                                        {testimonial.property.state}{" "}
                                        {testimonial.property.postalCode},{" "}
                                        {testimonial.property.country}
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="mt-16 text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
                        Join thousands of satisfied customers and find your perfect rental property
                        today.
                    </p>
