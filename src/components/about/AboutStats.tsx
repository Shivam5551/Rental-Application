        ...
        <section className="py-20 bg-white dark:bg-slate-950">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {statsData.map((stat, index) => {
                        ...
                        return (
                            ...
                            >
                                <div
                                    className={`w-16 h-16 ${colors.bg} rounded-xl flex items-center justify-center mx-auto mb-6`}
                                >
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-linear-to-r from-orange-600 to-orange-700 dark:from-orange-700 dark:to-orange-800 rounded-2xl p-8 text-white">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="w-full bg-white/20 rounded-full h-2">
                                <div
                                    ...
                                    style={{
                                        width: `${(verifiedProperties / totalProperties) * 100}%`,
                                    }}
                                ></div>
                            </div>
                            <div className="text-sm opacity-90">
                                {Math.round((verifiedProperties / totalProperties) * 100)}% of
                                properties are verified
                            </div>
                        </div>
                    </div>

                    <div className="bg-linear-to-r from-blue-600 to-blue-700 dark:from-blue-700 dark:to-blue-800 rounded-2xl p-8 text-white">
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-bold">
                                        {(averageRating._avg.rating || 0).toFixed(1)}/5
                                    </span>
                                </div>
                            </div>
                            <div className="w-full bg-white/20 rounded-full h-2">
                                <div
                                    ...
                                    style={{
                                        width: `${((averageRating._avg.rating || 0) / 5) * 100}%`,
                                    }}
                                ></div>
                            </div>
                            <div className="text-sm opacity-90">
