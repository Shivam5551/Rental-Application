                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                            To democratize access to quality rental properties across India by
                            creating a transparent, secure, and user-friendly platform that connects
                            property owners with tenants seamlessly.
                        </p>
                    </div>
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                            ...
                            do. We believe in building lasting relationships through trust and
                    ...
                    <div className="bg-linear-to-r from-orange-600 to-orange-700 dark:from-orange-700 dark:to-orange-800 rounded-2xl p-12 text-white">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <p className="text-xl leading-relaxed opacity-95">
                                Founded in {new Date().getFullYear()}, BookIT emerged from a simple
                                observation: finding quality rental properties in India was
                                unnecessarily complicated and often unreliable. Our founders, having
                                experienced these challenges firsthand, set out to create a platform
                                that would revolutionize how people discover, evaluate, and book
