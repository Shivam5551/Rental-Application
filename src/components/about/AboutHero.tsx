...
export const AboutHero = () => {
    return (
        <section className="relative py-20 overflow-hidden">
            <div className="absolute inset-0 bg-linear-to-br from-orange-50 via-white to-orange-50 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900"></div>
                    ...
                    <div className="space-y-8">
                        <div>
                            <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                                About{" "}
                                <span className="text-orange-600 dark:text-orange-400">BookIT</span>
                            </h1>
                            <p className="text-xl text-gray-600 dark:text-gray-300 mt-6">
                                Revolutionizing the rental property experience in India through
                                transparency, trust, and technology-driven solutions.
                            </p>
                        </div>
