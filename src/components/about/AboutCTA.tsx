    ...
    return (
        <section className="py-20 bg-white dark:bg-slate-950">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-linear-to-r from-orange-600 to-orange-700 dark:from-orange-700 dark:to-orange-800 rounded-3xl p-12 lg:p-16 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
                            Join the BookIT community today and discover your perfect rental
                            property with our transparent, secure, and user-friendly platform.
                        </p>
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 mb-2">Our headquarters</p>
