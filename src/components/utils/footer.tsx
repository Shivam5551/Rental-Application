...
export const Footer = () => {
    const quickLinks = [
        ...
        { href: "/property/rent", label: "List Your Property" },
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-300 text-sm leading-relaxed">
                            Your trusted platform for short-term property rentals. Find the perfect
                            place for your next stay or list your property with confidence.
                        </p>
