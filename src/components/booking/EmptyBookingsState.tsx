        ...
        <div className="min-h-[60vh] flex items-center justify-center">
            <div className="text-center max-w-md mx-auto px-4">
                <div className="w-32 h-32 mx-auto mb-8 relative">
                    <div className="w-full h-full bg-linear-to-br from-orange-100 to-orange-200 dark:from-orange-900/20 dark:to-orange-800/20 rounded-full flex items-center justify-center">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed text-lg">
                    Your adventure awaits! Discover amazing properties and create unforgettable
                    memories.
                </p>
