    ...
    return (
        <div className='flex items-center gap-2 mt-2 justify-evenly'>
            <button 
                ...
                className="px-4 py-2 hover:shadow-md w-full bg-orange-600 text-white text-sm rounded-lg hover:bg-orange-700 transition-colors"
            >
                Book Now
            </button>
            <button 
                onClick={handleViewDetailsClick}
                className="px-4 py-2 bg-blue-600 hover:shadow-md w-full text-white text-sm rounded-lg hover:bg-blue-700 transition-colors"
            >
                View Details
            </button>
        </div>
