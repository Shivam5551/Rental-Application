...
export default async function AddReviewPage({ params, searchParams }: AddReviewPageProps) {
  ...
  if (!session || !session.user?.id) {
    redirect('/api/auth/signin?callbackUrl=' + encodeURIComponent(`/reviews/add/${(await params).pid}`));
  }
      ...
      <div className="bg-gradient-to-r from-orange-600 to-orange-700 dark:from-orange-700 dark:to-orange-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <p className="text-orange-100 text-lg max-w-2xl">
            Help other travelers by sharing your honest feedback about your stay at this property.
          </p>
        </div>
      </div>
